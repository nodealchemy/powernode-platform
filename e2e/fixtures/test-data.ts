...
export const ROUTES = {
  ...
  controlApprovals: '/app/ai/control/approvals/queue',
  controlComplianceRules: '/app/ai/control/policies/compliance-rules',
  controlBudgets: '/app/ai/control/budgets',
  controlSafety: '/app/ai/control/safety',
  controlIdentities: '/app/ai/control/safety/identities',
  controlTrust: '/app/ai/control/trust-lineage/trust',
  controlAuditLog: '/app/ai/control/compliance-audit/audit-log',
  controlAsiCompliance: '/app/ai/control/compliance-audit/asi-compliance',
