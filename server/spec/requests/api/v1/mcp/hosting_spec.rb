...
RSpec.describe 'Api::V1::Mcp::Hosting', type: :request do
  ...
  before do
    # Routes for MCP hosting are defined in the business submodule
    skip 'MCP hosting routes require business module' unless Rails.application.routes.url_helpers.method_defined?(:api_v1_mcp_hosting_servers_path)
