...
RSpec.describe 'Api::V1::Ai::AgentTeams', type: :request do
  ...
  describe 'GET /api/v1/ai/agent_teams/:id' do
    ...
    context 'with valid authentication' do
      ...
      # Worker-side consumers resolve the owning account from this response;
      # account_id must stay at the top level of the payload.
      it 'includes account_id at the top level' do
        get "/api/v1/ai/agent_teams/#{team.id}", headers: headers, as: :json
