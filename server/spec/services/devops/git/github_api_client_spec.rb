...
RSpec.describe Devops::Git::GithubApiClient do
  ...
  describe '#test_connection' do
    ...
    context 'when authentication fails' do
      ...
      it 'raises authentication error' do
        expect { client.test_connection }.to raise_error(Devops::Git::ApiClient::AuthenticationError)
      end
    end
  end
  ...
  describe 'error handling' do
    it 'raises RateLimitError on 403 with rate limit message' do
      ...
      expect { client.test_connection }.to raise_error(Devops::Git::ApiClient::RateLimitError)
    end
    ...
    it 'raises ServerError on 500' do
      ...
      expect { client.test_connection }.to raise_error(Devops::Git::ApiClient::ServerError)
    end
  end
end
