...
FactoryBot.define do
  factory :ai_provider_credential, class: "Ai::ProviderCredential" do
    association :account
    ...
    trait :openai do
      association :provider, factory: [ :ai_provider, :openai ]
    ...
    trait :anthropic do
      association :provider, factory: [ :ai_provider, :anthropic ]
