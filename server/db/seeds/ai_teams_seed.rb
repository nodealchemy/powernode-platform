...
teams_data = [
  {
    ...
    description: 'Hierarchical team for automated code review, security analysis, and quality reporting. Lead assigns tasks and aggregates findings.',
    team_type: 'hierarchical',
    coordination_strategy: 'manager_led',
    goal_description: 'Review code for correctness, security, and maintainability',
    team_config: {
      'max_iterations' => 5,
      'timeout_seconds' => 600,
    ...
    roles: [
      ...
      },
      {
        ...
        role_description: 'Formats findings into clear, developer-friendly reports',
        responsibilities: 'Generate markdown reports, create inline comments, summarize findings',
        goals: 'Produce clear, actionable review documentation',
    ...
    channels: [
      {
        ...
        description: 'Team announcements and review status updates',
      ...
      },
      {
        name: 'review-tasks',
        channel_type: 'task',
        description: 'Review task assignments and completion notifications',
        participant_roles: %w[Review\ Lead Code\ Reviewer Report\ Writer],
  ...
  },
  {
    ...
    description: 'Mesh team where peers collaborate on research, data analysis, and synthesis. All members communicate directly.',
    team_type: 'mesh',
    coordination_strategy: 'consensus',
    goal_description: 'Research topics collaboratively and produce synthesized analytical reports',
    team_config: {
      'max_iterations' => 8,
      'timeout_seconds' => 900,
      'retry_on_failure' => true,
    ...
    roles: [
      ...
      },
      {
        ...
        role_description: 'Performs quantitative analysis, trend detection, visualization',
        responsibilities: 'Analyze datasets, identify trends, create statistical summaries',
        goals: 'Extract meaningful quantitative insights',
      ...
      },
      {
        ...
        role_type: 'worker',
        agent_slug: 'claude-content-creator',
        role_description: 'Synthesizes findings into polished reports and presentations',
    ...
    channels: [
      {
        ...
        channel_type: 'broadcast',
        description: 'Shared findings and coordination messages',
  ...
  },
  {
    ...
    description: 'Sequential pipeline: scan code, analyze results, validate deployment readiness, report. Each stage feeds the next.',
    team_type: 'sequential',
    coordination_strategy: 'manager_led',
    goal_description: 'Run sequential pipeline stages from scanning through deployment validation',
    team_config: {
      'max_iterations' => 4,
    ...
    roles: [
      ...
      },
      {
        ...
        role_description: 'Monitors pipeline health, resource usage, performance metrics',
        responsibilities: 'Track execution metrics, detect anomalies, report performance issues',
        goals: 'Maintain pipeline health and identify bottlenecks',
      ...
      },
      {
        ...
        role_type: 'worker',
        agent_slug: 'claude-content-creator',
        role_description: 'Generates execution reports, changelogs, and deployment summaries',
        responsibilities: 'Create execution reports, format results, generate deployment notes',
        goals: 'Produce comprehensive pipeline documentation',
