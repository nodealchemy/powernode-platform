...
module KnowledgeBase
  class Article < ApplicationRecord
    ...
    has_many :comments, class_name: "KnowledgeBase::Comment", foreign_key: "article_id", dependent: :destroy
    has_many :article_views, class_name: "KnowledgeBase::ArticleView", foreign_key: "article_id", dependent: :destroy
    has_many :workflows, class_name: "KnowledgeBase::Workflow", foreign_key: "article_id", dependent: :destroy
    ...
    def tag_names=(names)
      self.tags = names.map do |name|
        KnowledgeBase::Tag.find_or_create_by(name: name.strip) do |tag|
    ...
    def related_articles(limit: 5)
      ...
      related_by_tags = KnowledgeBase::Article
        .joins(:article_tags)
    ...
    def ensure_unique_slug(base_slug)
      ...
      while KnowledgeBase::Article.where(slug: slug_candidate).where.not(id: id).exists?
