...
module FileManagement
  class Storage < ApplicationRecord
    ...
    # Associations
    belongs_to :account
    has_many :objects, class_name: "FileManagement::Object", foreign_key: :file_storage_id, dependent: :restrict_with_error
    has_many :versions, class_name: "FileManagement::Version", through: :objects, source: :versions
