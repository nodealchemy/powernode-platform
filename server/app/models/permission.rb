...
class Permission < ApplicationRecord
  ...
  class << self
    ...
    def sync_from_config!
      ...
      # Also create extension-registered permissions so seeds know about
      # them (and so the description landing in the Permission row is the
      # extension's, not an autogenerated fallback). Idempotent — rows
      # created by migrations are reused.
      Permissions.extension_permissions.each do |name, description|
        find_or_create_from_name!(name, description)
      end
    end
