...
module Devops
  class IntegrationExecution < ApplicationRecord
    ...
    # ==================== Associations ====================
    belongs_to :instance, class_name: "Devops::IntegrationInstance", foreign_key: "integration_instance_id"
    belongs_to :account
    belongs_to :triggered_by_user, class_name: "User", optional: true
    belongs_to :parent_execution, class_name: "Devops::IntegrationExecution", optional: true

    has_many :retry_executions, class_name: "Devops::IntegrationExecution", foreign_key: :parent_execution_id, dependent: :nullify
    ...
    def execution_details
      execution_summary.merge(
        ...
        integration_instance: instance.instance_summary
      )
    end
