    ...
    module Ai
      class AgentTeamExecutionsController < ApplicationController
        ...
        def cancel
          ...
          log_audit_event("ai.agent_team.execution_cancel_requested", @execution, execution_id: @execution.execution_id)
        ...
        def pause
          ...
          log_audit_event("ai.agent_team.execution_pause_requested", @execution, execution_id: @execution.execution_id)
        ...
        def resume
          ...
          log_audit_event("ai.agent_team.execution_resume_requested", @execution, execution_id: @execution.execution_id)
