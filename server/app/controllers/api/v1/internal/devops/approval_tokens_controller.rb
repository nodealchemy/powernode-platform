  ...
  module V1
    module Internal
      module Devops
        ...
        #
        # fc-27: merged from two controllers that each covered half of
        # Devops::StepApprovalToken's worker-facing surface — the former
        # Api::V1::Internal::ApprovalTokensController (#show, #create_tokens,
        # scoped by :step_execution_id) and this controller's original
        # #expire_stale / #pending_count (account-wide collection actions).
        class ApprovalTokensController < InternalBaseController
          include Api::V1::Internal::WorkerTenancy

          # GET /api/v1/internal/devops/approval_tokens/:step_execution_id
          ...
          # POST /api/v1/internal/devops/approval_tokens/:step_execution_id/create_tokens
