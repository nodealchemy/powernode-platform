  ...
  module V1
    module Devops
      class IntegrationExecutionsController < ApplicationController
        ...
        # GET /api/v1/devops/integration_executions/:id
        def show
          authorize_action!("devops.integrations.read")
        ...
        # POST /api/v1/devops/integration_executions/:id/retry
        def retry
        ...
        # POST /api/v1/devops/integration_executions/:id/cancel
        def cancel
          authorize_action!("devops.integrations.execute")
        ...
        def stats
          ...
          stats = {
            ...
            avg_execution_time_ms: scope.where(status: "completed").average(:duration_ms)&.round(2),
            success_rate: calculate_success_rate(scope),
            by_day: scope.group_by_day(:created_at).count,
