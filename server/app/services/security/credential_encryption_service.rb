...
module Security
  ...
  #   encrypted = Security::CredentialEncryptionService.encrypt({ api_key: 'secret', token: 'value' })
  #
  #   # Decrypt to get original hash
  #   credentials = Security::CredentialEncryptionService.decrypt(encrypted)
  #
  #   # Encrypt a single value
  #   encrypted_token = Security::CredentialEncryptionService.encrypt_value('my-secret-token')
  #   token = Security::CredentialEncryptionService.decrypt_value(encrypted_token)
  #
  #   # Scoped encryption with namespace (for key isolation)
  #   encrypted = Security::CredentialEncryptionService.encrypt(data, namespace: 'mcp')
  #   credentials = Security::CredentialEncryptionService.decrypt(encrypted, namespace: 'mcp')
  #
  class CredentialEncryptionService
    ...
    class << self
      ...
      def encrypt(credentials_hash, namespace: nil)
        ...
        Rails.logger.error "[Security::CredentialEncryptionService] Encryption failed: #{e.message}"
      ...
      def decrypt(encrypted_credentials, namespace: nil)
        ...
        begin
          ...
          Rails.logger.error "[Security::CredentialEncryptionService] Decryption failed: #{e.message}"
      ...
      def validate_version(version)
        # Support both v1 (legacy Ai::Security::CredentialEncryptionService) and v2
