...
module Ai
  ...
  class ToolRelevanceFilter
    ...
    INTENT_TOOL_PATTERNS = {
      ...
      "governance" => /\A(governance_|create_agent_goal|update_agent_goal|list_agent_goals|decompose_goal|escalate|create_proposal|propose_feature|report_issue|request_feedback|detect_collusion|emit_signal|perceive_signals|reinforce_signal|measure_pressure|perceive_pressure|send_proactive_notification|emergency_|kill_switch_status)/,
