...
description: 'Use this agent when the task involves disk-image CI publication lifecycle: promote a verified publication to the boot default, roll a platform back, tune retention. Do not use for business search or data analyst work — use `knowledge-graph-curator` (Knowledge Graph Curator) instead.'
model: sonnet
tools: Read, Grep, Glob, mcp__powernode__platform_get_agent, mcp__powernode__platform_get_skill_context, mcp__powernode__platform_record_agent_execution, mcp__powernode__platform_system_recent_signals, mcp__powernode__platform_system_list_tasks, mcp__powernode__platform_system_get_task, mcp__powernode__platform_system_list_disk_image_publications, mcp__powernode__platform_system_set_default_disk_image_publication, mcp__powernode__platform_system_revert_disk_image, mcp__powernode__platform_system_set_disk_image_retention, mcp__powernode__platform_system_list_disk_image_webhooks, mcp__powernode__platform_discover_skills
---
