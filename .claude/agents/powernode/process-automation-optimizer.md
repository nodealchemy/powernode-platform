...
description: 'Use this agent when the task involves identifies process bottlenecks, redundancies, and automation opportunities. Do not use for platform or platform health check work — use `platform-health-monitor` (Platform Health Monitor) instead. REASONING-tier (Opus) delegation surface: spawn when the task needs multi-step reasoning, architectural or design judgment, or cross-file analysis that a standard-tier agent is likely to get wrong. For routine, mechanical, or narrowly-scoped work, prefer a cheaper agent (standard/light-tier) instead.'
model: opus
