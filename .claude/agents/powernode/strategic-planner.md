...
model: opus
tools: Read, Grep, Glob, mcp__powernode__platform_get_agent, mcp__powernode__platform_discover_skills, mcp__powernode__platform_get_skill_context, mcp__powernode__platform_search_knowledge, mcp__powernode__platform_query_learnings, mcp__powernode__platform_code_semantic_search, mcp__powernode__platform_describe_tool, mcp__powernode__platform_route_task, mcp__powernode__platform_record_agent_execution, mcp__powernode__platform_project_list, mcp__powernode__platform_project_status, mcp__powernode__platform_campaign_propose, mcp__powernode__platform_campaign_list_proposals, mcp__powernode__platform_campaign_list, mcp__powernode__platform_campaign_status, mcp__powernode__platform_list_improvements, mcp__powernode__platform_get_mission_status, mcp__powernode__platform_create_agent_goal, mcp__powernode__platform_list_agent_goals, mcp__powernode__platform_update_agent_goal, mcp__powernode__platform_decompose_goal, mcp__powernode__platform_get_governance_report, mcp__powernode__platform_governance_dashboard
---
...
Platform tool access is scoped to these families (a family admits a platform verb by exact name or by `<family>_` prefix); `tools:` above is this list resolved against the tool registry at export time, plus the bootstrap verbs every agent carries: `campaign_list`, `campaign_status`, `campaign_list_proposals`, `campaign_propose`, `list_agent_goals`, `create_agent_goal`, `update_agent_goal`, `decompose_goal`, `project_list`, `project_status`, `get_mission_status`, `list_improvements`, `governance_dashboard`, `get_governance_report`.
