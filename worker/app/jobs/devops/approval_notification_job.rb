...
module Devops
  ...
  class ApprovalNotificationJob < BaseJob
    ...
    def fetch_step_execution_details(step_execution_id)
      response = api_client.get("/api/v1/internal/devops/approval_tokens/#{step_execution_id}")
      response['data']
    ...
    def create_approval_tokens(step_execution_id, recipients)
      response = api_client.post(
        "/api/v1/internal/devops/approval_tokens/#{step_execution_id}/create_tokens",
    ...
    def send_approval_email(token_data, step_details)
      ...
      approve_url = "#{base_url}/devops/approve/#{raw_token}"
      reject_url = "#{base_url}/devops/reject/#{raw_token}"
      dashboard_url = "#{base_url}/app/devops/runs/#{step_details.dig('pipeline_run', 'id')}"
      ...
      <<~HTML
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>Powernode Platform - DevOps Pipeline Approval</p>
