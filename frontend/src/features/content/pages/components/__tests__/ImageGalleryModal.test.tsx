...
import { filesApi } from '@/features/content/files/services/filesApi';

// Mock the files API
jest.mock('@/features/content/files/services/filesApi');
...
jest.mock('@/features/content/files/components/FileUpload', () => ({
