  ...
  return (
    <div className="max-w-md mx-auto space-y-6">
      <div className="text-center">
        <div className="w-16 h-16 mx-auto bg-theme-info-bg rounded-full flex items-center justify-center mb-4">
          <svg className="w-8 h-8 text-theme-info-fg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
