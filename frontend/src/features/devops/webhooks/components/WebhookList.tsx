                    ...
                    <tr className="hover:bg-theme-surface-hover transition-colors duration-200">
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-2">
                          ...
                          {webhook.event_types.length > 0 && (
                            <Button variant="outline" onClick={() => toggleRowExpansion(webhook.id)}
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center justify-end gap-2">
                          <Button variant="outline" onClick={() => onView(webhook)}
                          ...
                          {onDelete && (
                            <Button variant="outline" onClick={() => onDelete(webhook.id)}
