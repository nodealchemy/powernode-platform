        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-theme-surface rounded border border-theme text-theme-primary focus:outline-none focus:ring-2 focus:ring-theme-interactive-primary"
