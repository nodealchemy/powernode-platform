        ...
        <div className="border-t border-theme bg-theme-surface p-3 space-y-2">
          ...
          >
            <textarea
              ...
              className="flex-1 resize-none px-3 py-2 text-sm rounded-md bg-theme-background-secondary border border-theme text-theme-primary placeholder:text-theme-text-secondary focus:outline-none focus:ring-1 focus:ring-theme-interactive-primary disabled:opacity-50"
            />
            <button
              type="submit"
