    ...
    },
    {
      ...
      render: (policy: LicensePolicy) => (
        <label className="relative inline-flex items-center cursor-pointer">
          ...
          />
          <div className="w-11 h-6 bg-theme-background-tertiary peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-theme-interactive-primary/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-theme after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-theme-interactive-primary"></div>
        </label>
      ),
    },
    {
      ...
      render: (policy: LicensePolicy) => (
        <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
          ...
          <button
            ...
            className="p-1.5 text-theme-secondary hover:text-theme-error-fg hover:bg-theme-error-fg/10 rounded"
            title="Delete policy"
          >
