    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <Card className="p-6">
          ...
          <p className={`text-3xl font-bold ${metersExceeded > 0 ? 'text-theme-error-fg' : 'text-theme-success-fg'}`}>
              ...
              {meter.quota_limit && (
                <div className="mt-2">
                  <div className="w-full bg-theme-background-secondary rounded-full h-1.5">
                    <div
                      className={`h-1.5 rounded-full ${meter.quota_exceeded ? 'bg-theme-error-bg' : 'bg-theme-interactive-primary'}`}
