          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-br from-blue-600/20 via-violet-600/10 to-transparent p-12 md:p-16 rounded-3xl border border-white/10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                {registrationEnabled && (
                  <Link to="/pricing" className="inline-flex items-center justify-center px-10 py-4 bg-theme-info-fg hover:bg-theme-interactive-primary-hover text-white font-semibold rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg shadow-blue-600/30 text-lg">
                    Start Building
                    <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                    </svg>
