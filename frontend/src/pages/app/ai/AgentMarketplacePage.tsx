      ...
      <div className="flex flex-wrap gap-4 mb-6">
        <div className="flex-1 min-w-64">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-sm border border-theme rounded-md bg-theme-surface text-theme-primary focus:outline-none focus:ring-2 focus:ring-theme-focus"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-3 py-2 text-sm border border-theme rounded-md bg-theme-surface text-theme-primary focus:outline-none focus:ring-2 focus:ring-theme-focus"
          >
...
export const AgentMarketplaceContent: React.FC = () => {
  const dispatch = useDispatch<AppDispatch>();
  const [templates, setTemplates] = useState<AgentTemplate[]>([]);
  const [featuredTemplates, setFeaturedTemplates] = useState<AgentTemplate[]>([]);
  const [categories, setCategories] = useState<MarketplaceCategory[]>([]);
