...
/**
 * Path-based tab definitions for the Credits hub. Each tab maps to a URL
 * segment under `basePath` so navigating tabs updates the URL (and the
 * parent page's breadcrumbs). The Credits area is gated as a whole by
 * `ai.analytics.read` (see shared/utils/navigation.tsx); the original tabs
 * had no per-tab gating, so every tab shares that single permission to
 * preserve the "all tabs visible together" behavior exactly.
 *
...
interface CreditsContentProps {
  /** URL prefix the tab keys append to. Provided by the parent page. */
  basePath?: string;
}

export const CreditsContent: React.FC<CreditsContentProps> = ({ basePath = '/app/ai/cost/credits' }) => {
  ...
  const emptyState = (
    <div className="text-center py-12" data-testid="credits-no-access">
      <Coins className="h-12 w-12 text-theme-tertiary mx-auto mb-4 opacity-50" />
      <p className="text-theme-secondary">You do not have permission to view credits.</p>
    </div>
  );
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Path-based tabs — each tab updates the URL segment under basePath */}
      <PathTabs tabs={CREDIT_TABS} basePath={basePath} hasPermission={hasPermission} emptyState={emptyState}>
        {loading ? (
                  ...
                  <div className="bg-theme-surface border border-theme rounded-lg p-6">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Link
                        ...
                        data-testid="credits-view-all-transactions"
                      >
                      ...
                      {packs.map(pack => (
                        ...
                        >
                          ...
                          <button
                            ...
                            data-testid={`credits-purchase-${pack.id}`}
                          >
                  ...
                  <div className="flex flex-wrap gap-4 mb-4">
                    <div className="flex-1 min-w-64">
                      <div className="relative">
                        ...
                        <input
                          ...
                          data-testid="credits-transactions-search"
                        />
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <select
                        ...
                        data-testid="credits-type-filter"
                      >
                ...
                <div className="space-y-4">
                  {transfers.length === 0 ? (
                    <div className="text-center py-12 bg-theme-surface border border-theme rounded-lg">
                      ...
                      <button className="btn-theme btn-theme-primary" data-testid="credits-create-transfer">
                        Create Transfer
                      </button>
                    </div>
                  ) : (
                          ...
                          {transfer.status === 'pending' && (
                            <div className="flex gap-2">
                              <button
                                ...
                                data-testid={`credits-transfer-approve-${transfer.id}`}
                              >
                              ...
                              <button
                                ...
                                data-testid={`credits-transfer-cancel-${transfer.id}`}
                              >
                  ...
                  {!balance?.is_reseller ? (
                    <div className="text-center py-12 bg-theme-surface border border-theme rounded-lg">
                      ...
                      <button
                        ...
                        data-testid="credits-enable-reseller"
                      >
