                ...
                {footerData && (footerData.social_facebook || footerData.social_twitter || footerData.social_linkedin || footerData.social_instagram || footerData.social_youtube) && (
                  <div className="flex items-center space-x-4">
                    {footerData.social_facebook && (
                      <a href={footerData.social_facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-theme-tertiary hover:text-theme-primary transition-colors duration-200">
                        <Users className="w-5 h-5" />
                      </a>
                    )}
                    {footerData.social_twitter && (
                      <a href={footerData.social_twitter} target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-theme-tertiary hover:text-theme-primary transition-colors duration-200">
                        <MessageCircle className="w-5 h-5" />
                      </a>
                    )}
                    {footerData.social_linkedin && (
                      <a href={footerData.social_linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-theme-tertiary hover:text-theme-primary transition-colors duration-200">
                        <Briefcase className="w-5 h-5" />
                      </a>
                    )}
                    {footerData.social_instagram && (
                      <a href={footerData.social_instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-theme-tertiary hover:text-theme-primary transition-colors duration-200">
                        <Camera className="w-5 h-5" />
                      </a>
                    )}
                    {footerData.social_youtube && (
                      <a href={footerData.social_youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-theme-tertiary hover:text-theme-primary transition-colors duration-200">
          ...
          <div className="py-8">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
              <div className="flex flex-wrap items-center gap-6 text-sm text-theme-tertiary">
                <span>© {footerData?.copyright_year || new Date().getFullYear()} {footerData?.copyright_text || 'Everett C. Haimes III'}</span>
                <div className="flex items-center space-x-6">
